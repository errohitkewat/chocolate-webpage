...
const HeroSection = () => {
  return (
    <div id="heroSection" className='h-full pt-35 pb-70 px-45 w-full '>
      ...
      <div className=" mt-70 border-white  flex items-center justify-center  " >
        <a className="text-xl underline underline-offset-5 decoration-1 uppercase text-white font-extralight" href="">Order Online</a>
      </div>
    </div>
  )
}
